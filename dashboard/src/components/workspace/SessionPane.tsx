...
// One open session: a tab bar (Terminal / Claude) + machine chip. Both tabs
// stay mounted once opened so switching doesn't drop the live socket/scrollback.
// File browsing now lives in the persistent right-rail explorer.
