...
function TopBar({ view, onView, fleet, activeFile }) {
  ...
  return (
    <header className="topbar">
      ...
      <div className="tb-search">
        ...
        <span className="mono" style={{ marginLeft: "auto", fontSize: 11, color: "var(--fg-3)" }}>⌘K</span>
      </div>
      <button className="iconbtn"><Icon name="activity" size={17} /></button>
